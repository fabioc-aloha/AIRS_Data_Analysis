...
The complete model explained 86.1% of variance in behavioral intention (R² = .861), an exceptionally high value for technology adoption research that demonstrates the comprehensive nature of the validated framework.
...
This dissertation addresses the timely challenge of understanding why individuals adopt or resist AI tools in professional contexts. The findings reveal that AI adoption operates through different mechanisms than previous technology adoption, with cost-benefit perceptions and intrinsic enjoyment mattering more than conventional utility considerations. The validated AIRS instrument provides researchers with a psychometrically sound foundation for investigating AI adoption, while the theoretical contributions advance scholarly understanding of how technology acceptance models must evolve for emerging technology contexts.

As AI transforms professional work, understanding adoption psychology becomes increasingly critical. This dissertation establishes a validated foundation that can enable future diagnostic tools, intervention protocols, and assessment systems to help organizations close the persistent gap between AI adoption and value realization.
